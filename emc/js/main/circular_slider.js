  ...
  function Plugin($container, options) {
    ...
    function _setEvents() {
      ...
      $container.delegate(".dot", eventType, function (event) {
        ...
        changeText(event.currentTarget.innerHTML);
        //console.log(event);
    ...
    function changeText(innerText){
    	//console.log(innerText);
    	
    	var ancestor = document.getElementById('wheel-dynamic-content'),
    		descendents = ancestor.childNodes;
    	
    	
    	$('#wheel-dynamic-content').find('div').each(function(){
    		...
    		$("#" + innerDivId).hide();
    		if(innerText.includes(innerDivId) ){
    			//alert('Please work');
        		$("#" + innerDivId).show();
        		//$('#DataAssimilation').hide();
        	}else if( innerText.includes('Data&nbsp;Assimilation')){
        		$('#DataAssimilation').show();
        	}else if( innerText.includes('Mission')){
        		$("#wheelInfo").show();
        	}
        ...
        if ($(dot.dot).length > 0) {
          if (index === 4) {
            ...
            $(dot.dot)
              .addClass("dot-" + (index + 1))
              .attr('data-slide-index', index)
              .html("<h1><div class='text'>" + options.slides[index] + "</div><div class='curve'>&nbsp;</div></h1>");
          }
        }
      });
...
$(document).ready(function() {
  ...
  //console.log('Width to aquire ' + widthtoacquire);
  var radius = (widthtoacquire - 80) / 2 > 150 ? 150 : (widthtoacquire - 80) / 2;
  //console.log('Radius ' + radius);
  $("#rotatescroll").css({
    width: widthtoacquire - 80,
    height: widthtoacquire - 80
  });
  $(".viewport, .overview li").css({
    width: widthtoacquire - 80,
    height: widthtoacquire - 80
  });
  $("#rotatescroll").tinycircleslider({
    ...
    radius: radius,
    dotsHide: false,
    slides: ["Mission","Marine", "Mesoscale", "Global", "Infrastructure", "Verification", "Data Assimilation"],
    interval: false
  });
