          ...
          <div class="contact-form">
           <div class="row">
               <div class="col-sm-7">   
                    ...
                    <form id="ajax-contact" action="/emc/contact-us" method="post" role="form">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="form_firstname" name="form[firstname]" required="required" class="form-control" placeholder="Please enter your firstname *" data-error="Firstname is required.">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="form_lastname" name="form[lastname]" required="required" class="form-control" placeholder="Please enter your lastname *" data-error="Lastname is required.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="form_email" name="form[email]" required="required" class="form-control" placeholder="Please enter your email *" data-error="Valid email is required.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" id="form_phone" name="form[phone]" required="required" class="form-control input-medium bfh-phone" data-country="US" placeholder="(xxx) xxx-xxxx">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="form_message" name="form[message]" required="required" class="form-control" placeholder="Message for me *" rows="4" data-error="Please,leave us a message."></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
