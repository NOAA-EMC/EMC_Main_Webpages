            ...
            <p><a href="obs-data/bufrtab_tablea.php" target="_blank"><span style="color: rgb(0, 0, 255);">BUFR Table A</span></a> </p>
            
            <p><a href="obs-data/bufrtab_tableb.php" target="_blank"><span style="color: rgb(0, 0, 255);">BUFR Table B Descriptors and Mnemonics in NCEP Observational Database</span></a> </p>
            
            <p><a href="obs-data/bufrtab_tabled.php" target="_blank"><span style="color: rgb(0, 0, 255);">BUFR Table D Descriptors and Mnemonics in NCEP Observational Database</span></a> </p>
