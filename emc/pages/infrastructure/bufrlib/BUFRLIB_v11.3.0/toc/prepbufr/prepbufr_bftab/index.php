...
.anchor{
 ...
 <div class="container-fluid">
  <div class="row">
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link sidelnk" href="obs-data-processing.php">
    ...
    <!-- <h2 id="section-title">BUFRLIB Software User Guide</h2>-->
        <div id="description">

<?php
#require("breadcrumb.shtml");
require("prepbufr_bftab_body.shtml");
?>
