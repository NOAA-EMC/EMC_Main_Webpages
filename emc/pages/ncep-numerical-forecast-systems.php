...
<div class="container-fluid  main-content">
		<section class="main-first-content-row">
			<div class="container">
				<div class="row">
				  <div class="col-lg-12"><h2 class="page-title">NCEP Numerical Forecast/Analysis Systems</h2><h2></h2></div>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<div class="col-lg-3 left-side-bar">
							<ul class="list-group">
								<li class="list-group-item"><a href="/emc/page/guidance-systems">Guidance Systems</a></li>							
    							<li class="list-group-item"><a href="/emc/page/nwp-systems" class="see-link">NCEP Numerical Forecast/Analysis Systems</a>
            						<ul class="list-group">
                							<li class="list-group-item">
                                                 <a href="#gfs">Global Forecasting System (GFS)</a>
                                            </li>
                                            <li class="list-group-item">
                                            	<a href="#gefs">Global Ensemble Forecast System (GEFS)</a>
                                            </li>
                                            <li class="list-group-item">
                                            ...
                                            <li class="list-group-item">
                                                <a href="#rap">Rapid Refresh (RAP)</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="#hrrr">High-Resolution Rapid Refresh (HRRR)</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="#sref">Short-range Ensemble Forecast (SREF)</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="#href-hiresw">High-Resolution Ensemble Forecast </a>
                                            </li>
                                            <li class="list-group-item">
                                               <a href="#global-rtofs">Global Real-Time Ocean Forecast System</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="#wavewatch-iii">Global Wave Model (WAVEWATCH III)</a>
                                            </li>
                                            <li class="list-group-item">
                                                 <a href="#hwrf">HWRF</a>
                                            </li>
                                            ...
                                            <li class="list-group-item">
                                                 <a href="#rtma">RTMA/URMA/RTMA-RU</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="#sst">NCEP Sea Surface Temperature Analysis</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="#naqfc">NCEP Air Quality Model</a>
                                            </li>
                                            <li class="list-group-item">
                                                   <a href="#gefsaero">GEFS-Aerosol Model</a>
                                            </li>
                                            <li class="list-group-item">
                                               <a href="#nldas">N.American Land Data Assimilation System</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="#nwps">Nearshore Wave Prediction System</a>
                                            </li>
                                            <li class="list-group-item">
                                                  <a href="#naefs">North American Ensemble Forecast System</a>
                                            </li>
                                            <li class="list-group-item">
                                                  <a href="#glw">Great Lakes Wave Model (WAVEWATCH III)</a>
                                            </li>
                                          </ul>
                						</li>                          										
    									<li class="list-group-item">
                                             <a href="https://www.emc.ncep.noaa.gov/emc/pages/verification.php">Verification</a>
                                        </li>
                                        <li class="list-group-item">
                                             <a href="https://www.emc.ncep.noaa.gov/emc/pages/emc-research-developmental-graphics.php">EMC Research and Development Graphics</a>
                                        </li>
                                        <li class="list-group-item">
                                             <a href="https://www.emc.ncep.noaa.gov/emc/pages/nomads.php">NOMADS</a>
                                        </li>
                                        <li class="list-group-item">
                                             <a href="https://www.emc.ncep.noaa.gov/emc/pages/documentation-support.php">Documentation and Support</a>
                                        </li>
						...
						<div class="col-lg-9">
							<div class="seminar-content-page">
								<p style="margin-left:0px; margin-right:0px; text-align:start"><img src="https://emc.ncep.noaa.gov/emc/images/forcast_system_icons/animated/GFS_North_America_Precipitation.gif" style="border: 0px none; box-sizing: border-box; vertical-align: middle;"></p>

<div class="img-caption" style="-webkit-text-stroke-width:0px; background-color:#ffffff; box-sizing:border-box; color:#333333; font-family:&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif; font-size:14px; font-style:normal; font-variant-caps:normal; font-variant-ligatures:normal; font-weight:normal; letter-spacing:normal; orphans:2; text-align:start; text-decoration-color:initial; text-decoration-style:initial; text-indent:0px; text-transform:none; white-space:normal; widows:2; word-spacing:0px">
<p style="margin-left:0px; margin-right:0px"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size:16px;">This animated precipitation map above an example of a 6 day interval from a run of the Global Forecast System (GFS).</span></span><br>
&nbsp;</p>
</div>

<p style="margin-left:0px; margin-right:0px; text-align:start"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size:16px;">Data from the NCEP numerical guidance systems listed below are available through NOAA's National Operational Model Archive and Distribution System (<a href="nomads.ncep.noaa.gov/index.shtml">NOMADS</a>).</span></span></p>
        					...
        					The Real-Time Ocean Forecast System (Global RTOFS) is based on an eddy-resolving version of the HYCOM (HYbrid Coordinates Ocean Model) at 1/12° degree resolution, run once/day at 00z. Each run starts with 48-h of hindcasting and produces full-volume forecasts from the initial time out to 8 days.  
										...
										<div class="col-lg-6">
     									...
     									<ul class="list-group">
                                            ...
                                            <span class="more">
                                                The NCEP operational global wave model (WAVEWATCH III) runs as coupled component to the NCEP Global Forecast System (GFS) and the Global Ensemble Forecast Systen (GEFS)
                                            </li>
                                         </ul>
                                      </div>
